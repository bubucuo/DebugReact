...
function pushInteractions(root) {
    if (enableSchedulerTracing) {
        const prevInteractions: Set<Interaction> | null =
...
// 如果当前fiber的优先级更高，需要打断当前执行的任务，立即执行该fiber上的update，则更新interruptedBy
...
function schedulePendingInteractions(root, expirationTime) {
    console.log("schedulePendingInteractions"); //sy-log
